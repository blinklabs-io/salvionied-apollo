...
This document describes how Plutus V3 cost models are handled in Apollo v2.
...
Cost models come from the Ogmios protocol parameters query, including genesis parameters for complete cost model data.
