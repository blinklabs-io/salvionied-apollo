...
a.PayToAddressWithReferenceScript(addr, 2_000_000, v3Script)
```

The script type is detected automatically. This replaces the v1 methods `PayToAddressWithV1ReferenceScript`, `PayToAddressWithV2ReferenceScript`, and `PayToAddressWithV3ReferenceScript`.
